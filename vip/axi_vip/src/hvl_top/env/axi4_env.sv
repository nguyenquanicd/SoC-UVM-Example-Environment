...
function void axi4_env::connect_phase(uvm_phase phase);
  ...
  foreach(axi4_master_agent_h[i]) begin
    if(axi4_env_cfg_h.has_scoreboard) begin
      axi4_master_agent_h[i].axi4_master_mon_proxy_h.axi4_master_read_address_analysis_port.connect(axi4_scoreboard_h.axi4_master_read_address_analysis_fifo);
  ...
  foreach(axi4_slave_agent_h[i]) begin
    if(axi4_env_cfg_h.has_scoreboard) begin
      axi4_slave_agent_h[i].axi4_slave_mon_proxy_h.axi4_slave_write_address_analysis_port.connect(axi4_scoreboard_h.axi4_slave_write_address_analysis_fifo);
      axi4_slave_agent_h[i].axi4_slave_mon_proxy_h.axi4_slave_write_data_analysis_port.connect(axi4_scoreboard_h.axi4_slave_write_data_analysis_fifo);
  ...
  if(axi4_env_cfg_h.has_scoreboard) axi4_scoreboard_h.axi4_env_cfg_h = axi4_env_cfg_h;
